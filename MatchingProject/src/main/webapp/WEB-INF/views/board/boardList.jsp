					...
					<form class="pull-right position" onsubmit="return false">
						<div class="input-append">
							<input id="keyword" type="text" class="sr-input"
								onkeydown="if(event.keyCode==13){javascript:searchEnter();}"
								placeholder="Search">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header"
					style="background-color: #41cac0; border-color: #41cac0; border-radius: 5px; color: white;">
			...
			<div
				...
				<div class="panel panel-primary">
					<div class="panel-heading"
						style="background-color: #41cac0; border-color: #41cac0; border-radius: 5px;">
